...
import certificateBackground from '../../../../../assets/images/aws-1.jpg';
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box width="700px" backgroundColor="#ffffff63" py={3} px={2}>
                    {/* --------Certificate header------- */}
                    <Box
                    ...
                    <Box textAlign="center">
                        ...
                        <Typography variant="h6" id="name2">
                            {name.toUpperCase()}
                        </Typography>
                        ...
                        <Typography variant="h6" className="pass-percentage-1">
