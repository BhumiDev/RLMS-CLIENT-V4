...
const certificateBackground =
    'https://dl.dropboxusercontent.com/s/x5v2milhwypyyyb/Cirtificate_Background.jpg?dl=0';
const rangestorm =
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box width="700px" backgroundColor="#ffffff87" py={3} px={2}>
                    {/* --------Certificate header------- */}
                    <Box
                    ...
                    <Box textAlign="center">
                        ...
                        <Typography variant="h6" id="name1">
                            {name.toUpperCase()}
                        </Typography>
