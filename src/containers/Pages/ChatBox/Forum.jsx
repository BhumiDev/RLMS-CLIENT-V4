...
import {
    createDiscussion,
    getCurrentUserDiscussionAnswer,
    getCurrentUserDiscussions,
    getDiscussionS,
...
export const DiscussionForum = () => {
    ...
    const handleQuillChange = (value) => {
        ...
        setQuestion(value);
        const isEmptyPlaceholder = value === '<p><br></p>';
        setDisableSubmit(isEmptyPlaceholder || !value.trim());
    };
                ...
                >
                    ...
                    <Grid
                        ...
                        sx={{
                            ...
                            borderLeftColor: 'primary.light',
                            backgroundColor:
                                selected === 'topics' && 'secondary.light'
                        }}
                    ...
                    <Grid
                        ...
                        sx={{
                            ...
                            borderLeftColor: 'primary.light',
                            backgroundColor:
                                selected === 'answers' && 'secondary.light'
                        }}
